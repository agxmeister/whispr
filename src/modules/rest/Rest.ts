...
export class Rest {
    ...
    async getEndpointDetails(route: OpenApiEndpointRoute): Promise<any> {
        ...
        return {
            ...
            parameters: target.definition.parameters?.filter(parameter => ["query", "path"].includes(parameter.in)) || null,
